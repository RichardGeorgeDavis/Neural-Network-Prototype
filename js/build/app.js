...
function ParticlePool( poolSize ) {
	...
	this.pMat_outer.size = this.pSize * 5; //10
	this.pMat_outer.opacity = 0.025;  //0.04;
...
function NeuralNetwork() {
	...
	// axon
	this.axonOpacityMultiplier = 1.0; //0.5
